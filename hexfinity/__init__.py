...
def _classes():
    ...
    return (
        ...
        segments.HEXFINITY_OT_add_corner,
        segments.HEXFINITY_UL_segment_corners,
        segments.HEXFINITY_OT_snap_corner_to_edge,
        ...
        segments.HEXFINITY_OT_manage_segments,
        segments.HEXFINITY_OT_close_manage_segments_dialog,
        segments.HEXFINITY_OT_remove_segment_entry,
        segments.HEXFINITY_OT_move_segment_entry,
